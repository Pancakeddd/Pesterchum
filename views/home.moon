  ...
  content: =>
    div class: "row", ->
      ...
      div id: "tab-container", ->
        div id: "test1", class: "col s10", -> p class: "chatbox", "yesyesyes"
        div id: "test2", class: "col s10", -> p class: "chatbox", "nonono"
        div id: "test3", class: "col s10", -> p class: "chatbox", "maybemaybemaybe"
      -- chumroll
      div class: "col s2", ->
        div class: "container", ->
          b "Chumroll"
